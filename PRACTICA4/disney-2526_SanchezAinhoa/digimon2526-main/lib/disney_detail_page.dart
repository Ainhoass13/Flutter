    ...
    return Hero(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            image: DecorationImage(fit: BoxFit.cover, image: NetworkImage(widget.disney.avatar ?? ""))),
      ),
    );
  }
  ...
  Widget get rating {
    return Row(
      ...
      children: <Widget>[
        ...
        Text('${widget.disney.rating}/10', style: const TextStyle(color: Colors.black, fontSize: 30.0))
      ],
    );
  }
  ...
  Widget get digimonProfile {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          disneyImage,
          Text(widget.disney.nombre, style: const TextStyle(color: Colors.black, fontSize: 32.0)),
          Text('${widget.disney.peli}', style: const TextStyle(color: Colors.black, fontSize: 20.0)),
          Padding(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Meet ${widget.disney.nombre}'),
      ),
      body: ListView(
